...
# n = 500, marker prevalence threshold for dichotomization = 0.2, one interim analysis
...
res <- Sim_Shell_Exponential(Nrep = 1000, seed = 500, n = 500, n_events = 400, m.prev.lwr = 0.2,							     
                             ...
                             FUN.ctl = function(x) {log(0.4)*x}, FUN.exp = function(x) {log(0.4)*x}, 
...
saveRDS(res, "./one_interim/output/setting3/trial_results.Rds")
