...
setwd("./simulations/one_interim/output/setting9")
...
marker.status.freq <- rbind(res1$marker.status.freq, res2$marker.status.freq, res3$marker.status.freq, res4$marker.status.freq)
