...
setwd("./simulations/one_interim/output/setting3")

library(xtable)

# n = 500, threshold for marker dichotomization = 0.2, one interim check
...
colnames(result) <- c("Interim Bayes", "Interim Freq", "Final Bayes", "Final Freq", "Overall Bayes", "Overall Freq", "Sample Size Bayes", "Sample Size Freq",
