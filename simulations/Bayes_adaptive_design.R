...
Bayes_adaptive_design <- function(surdata,                        # a data frame including trt (treatment arm indicator), enter (entry dates), x (continuous marker values), T (event times), and T_date (observed TTE dates) 
                                  ref, 							   			      # the reference point of the continuous marker x
