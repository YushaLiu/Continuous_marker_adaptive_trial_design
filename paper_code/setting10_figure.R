...
detection.rate[3,1] <- 1-prev1-prev2	# prevalence of markers whose trt effect is on the boundary
...
detection.rate[3,2] <- 1-prev1-prev2	# prevalence of markers whose trt effect is on the boundary
...
save(decision.rate, detection.rate, colors1, colors2, file=file.path(rDataPath,"setting10.RData"))
