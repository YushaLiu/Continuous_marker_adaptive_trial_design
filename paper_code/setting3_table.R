...
\begin{tabular}{rrrrrrrrrrrrrrrrr}
 ...
 & Interim Bayes & Interim Freq & Final Bayes & Final Freq & Overall Bayes & Overall Freq & Sample Size Bayes & Sample Size Freq & TPR1 Bayes & TPR1 Freq & TPR2 Bayes & TPR2 Freq & TNR1 Bayes & TNR1 Freq & TNR2 Bayes & TNR2 Freq \\ 
  \midrule
No Marker Detected & 0.822 & 0.599 & 0.226 & 0.198 & 0.815 & 0.645 & 381 & 398 &  &  &  &  & 0.980 & 0.967 & 0.980 & 0.967 \\ 
  Overall Efficacy & 0.002 & 0.010 & 0.004 & 0.009 & 0.016 & 0.021 &  &  &  &  &  &  &  &  &  &  \\ 
  Overall Futility & 0.559 & 0.326 & 0.222 & 0.189 & 0.799 & 0.624 &  &  &  &  &  &  &  &  &  &  \\ 
  Overall Continue & 0.261 & 0.263 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
  Marker Detected & 0.178 & 0.401 & 0.150 & 0.160 & 0.185 & 0.355 & 115 & 148 &  &  &  &  & 0.678 & 0.591 & 0.678 & 0.591 \\ 
  M+ Eff/M- Eff & 0.004 & 0.000 & 0.006 & 0.002 &  &  & 306 & 216 &  &  &  &  &  &  &  &  \\ 
  M+ Eff/M- Cont & 0.076 & 0.019 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Eff/M- Fut & 0.058 & 0.277 & 0.118 & 0.078 & 0.176 & 0.355 &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Cont/M- Eff & 0.006 & 0.000 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Cont/M- Cont & 0.029 & 0.000 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Cont/M- Fut & 0.004 & 0.076 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Fut/M- Eff & 0.000 & 0.000 & 0.009 & 0.000 & 0.009 & 0.000 &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Fut/M- Cont & 0.000 & 0.000 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Fut/M- Fut & 0.001 & 0.029 & 0.017 & 0.080 &  &  &  &  &  &  &  &  &  &  &  &  \\ 
   \bottomrule
\end{tabular}
\end{table}
