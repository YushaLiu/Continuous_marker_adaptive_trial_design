...
fnc.trt <- function(x) {
	if(x<=0.5) {
		-log(0.4)*exp(30*(x-0.3))/(1+exp(30*(x-0.3)))+log(0.4)
	}
	else {
		log(0.4)*exp(30*(x-0.7))/(1+exp(30*(x-0.7)))
	}
}
...
\begin{tabular}{rrrrrrrrrrrrrrrrr}
 ...
 & Interim Bayes & Interim Freq & Final Bayes & Final Freq & Overall Bayes & Overall Freq & Sample Size Bayes & Sample Size Freq & TPR1 Bayes & TPR1 Freq & TPR2 Bayes & TPR2 Freq & TNR1 Bayes & TNR1 Freq & TNR2 Bayes & TNR2 Freq \\ 
  \midrule
No Marker Detected & 0.117 & 0.191 & 0.001 & 0.002 & 0.415 & 0.958 & 402 & 385 & 0.998 & 1.000 & 0.998 & 1.000 & 0.002 & 0.000 & 0.002 & 0.000 \\ 
  Overall Efficacy & 0.110 & 0.174 & 0.001 & 0.002 & 0.414 & 0.958 &  &  &  &  &  &  &  &  &  &  \\ 
  Overall Futility & 0.001 & 0.000 & 0.000 & 0.000 & 0.001 & 0.000 &  &  &  &  &  &  &  &  &  &  \\ 
  Overall Continue & 0.006 & 0.017 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
  Marker Detected & 0.883 & 0.809 & 0.606 & 0.246 & 0.585 & 0.042 & 223 & 122 & 0.854 & 0.457 & 0.766 & 0.411 & 0.947 & 0.943 & 0.970 & 0.952 \\ 
  M+ Eff/M- Eff & 0.058 & 0.548 & 0.245 & 0.234 &  &  & 170 & 262 &  &  &  &  &  &  &  &  \\ 
  M+ Eff/M- Cont & 0.599 & 0.231 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Eff/M- Fut & 0.224 & 0.030 & 0.361 & 0.012 & 0.585 & 0.042 &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Cont/M- Eff & 0.002 & 0.000 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
