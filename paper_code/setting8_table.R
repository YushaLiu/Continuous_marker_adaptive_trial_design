...
fnc.trt <- function(x) {return(log(0.4)*(x^3))}
...
\begin{tabular}{rrrrrrrrrrrrrrrrr}
 ...
 & Interim Bayes & Interim Freq & Final Bayes & Final Freq & Overall Bayes & Overall Freq & Sample Size Bayes & Sample Size Freq & TPR1 Bayes & TPR1 Freq & TPR2 Bayes & TPR2 Freq & TNR1 Bayes & TNR1 Freq & TNR2 Bayes & TNR2 Freq \\ 
  \midrule
No Marker Detected & 0.189 & 0.224 & 0.022 & 0.036 & 0.216 & 0.242 & 405 & 401 & 0.681 & 0.835 & 0.681 & 0.835 & 0.319 & 0.165 & 0.319 & 0.165 \\ 
  Overall Efficacy & 0.019 & 0.076 & 0.002 & 0.013 & 0.147 & 0.202 &  &  &  &  &  &  &  &  &  &  \\ 
  Overall Futility & 0.045 & 0.015 & 0.020 & 0.023 & 0.069 & 0.040 &  &  &  &  &  &  &  &  &  &  \\ 
  Overall Continue & 0.125 & 0.133 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
  Marker Detected & 0.811 & 0.776 & 0.636 & 0.302 & 0.784 & 0.758 & 148 & 154 & 0.849 & 0.812 & 0.626 & 0.630 & 0.948 & 0.901 & 0.962 & 0.952 \\ 
  M+ Eff/M- Eff & 0.027 & 0.048 & 0.099 & 0.065 &  &  & 266 & 229 &  &  &  &  &  &  &  &  \\ 
  M+ Eff/M- Cont & 0.493 & 0.195 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Eff/M- Fut & 0.251 & 0.523 & 0.528 & 0.235 & 0.779 & 0.758 &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Cont/M- Eff & 0.006 & 0.000 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Cont/M- Cont & 0.028 & 0.000 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Cont/M- Fut & 0.005 & 0.010 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Fut/M- Eff & 0.000 & 0.000 & 0.005 & 0.000 & 0.005 & 0.000 &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Fut/M- Cont & 0.001 & 0.000 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Fut/M- Fut & 0.000 & 0.000 & 0.004 & 0.002 &  &  &  &  &  &  &  &  &  &  &  &  \\ 
   \bottomrule
\end{tabular}
\end{table}
