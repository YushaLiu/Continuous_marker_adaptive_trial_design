...
\begin{tabular}{rrrrrrrrrrrrrrrrr}
 ...
 & Interim Bayes & Interim Freq & Final Bayes & Final Freq & Overall Bayes & Overall Freq & Sample Size Bayes & Sample Size Freq & TPR1 Bayes & TPR1 Freq & TPR2 Bayes & TPR2 Freq & TNR1 Bayes & TNR1 Freq & TNR2 Bayes & TNR2 Freq \\ 
  \midrule
No Marker Detected & 0.030 & 0.159 & 0.000 & 0.003 & 0.113 & 0.124 & 404 & 361 & 0.947 & 0.984 & 0.947 & 0.984 & 0.053 & 0.016 & 0.053 & 0.016 \\ 
  Overall Efficacy & 0.004 & 0.100 & 0.000 & 0.003 & 0.107 & 0.122 &  &  &  &  &  &  &  &  &  &  \\ 
  Overall Futility & 0.006 & 0.002 & 0.000 & 0.000 & 0.006 & 0.002 &  &  &  &  &  &  &  &  &  &  \\ 
  Overall Continue & 0.020 & 0.057 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
  Marker Detected & 0.970 & 0.841 & 0.567 & 0.121 & 0.887 & 0.876 & 178 & 270 & 0.877 & 0.941 & 0.779 & 0.897 & 0.890 & 0.462 & 0.918 & 0.487 \\ 
  M+ Eff/M- Eff & 0.026 & 0.004 & 0.077 & 0.015 &  &  & 212 & 92 &  &  &  &  &  &  &  &  \\ 
  M+ Eff/M- Cont & 0.537 & 0.062 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Eff/M- Fut & 0.397 & 0.770 & 0.490 & 0.106 & 0.887 & 0.876 &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Cont/M- Eff & 0.001 & 0.000 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Cont/M- Cont & 0.008 & 0.000 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
  M+ Cont/M- Fut & 0.001 & 0.005 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\ 
